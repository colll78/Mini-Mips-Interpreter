...
/* package BytecodeInterpreter-0.1.0.0 */
#ifndef VERSION_BytecodeInterpreter
#define VERSION_BytecodeInterpreter "0.1.0.0"
#endif /* VERSION_BytecodeInterpreter */
#ifndef MIN_VERSION_BytecodeInterpreter
#define MIN_VERSION_BytecodeInterpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_BytecodeInterpreter */
/* package async-2.2.4 */
...
#define CURRENT_COMPONENT_ID "BytecodeInterpreter-0.1.0.0-inplace-BytecodeInterpreter"
