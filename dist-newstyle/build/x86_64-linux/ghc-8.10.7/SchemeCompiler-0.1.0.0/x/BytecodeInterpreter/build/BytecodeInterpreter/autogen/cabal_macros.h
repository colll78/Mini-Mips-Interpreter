...
/* package SchemeCompiler-0.1.0.0 */
#ifndef VERSION_SchemeCompiler
#define VERSION_SchemeCompiler "0.1.0.0"
#endif /* VERSION_SchemeCompiler */
#ifndef MIN_VERSION_SchemeCompiler
#define MIN_VERSION_SchemeCompiler(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_SchemeCompiler */
/* package async-2.2.4 */
...
#define CURRENT_COMPONENT_ID "SchemeCompiler-0.1.0.0-inplace-BytecodeInterpreter"
